...
import {
    ...
    buildSimulationBatchPayload,
} from "./simulationPayload";
...
export function useSimulationsPage(authFetch, token) {
    ...
    const [form, setForm] = useState(sanitizeFormValues(simulationFormDefaults));
    ...
    function closeForm() {
        ...
        setResult(null);
        setForm(sanitizeFormValues(simulationFormDefaults));
    }
